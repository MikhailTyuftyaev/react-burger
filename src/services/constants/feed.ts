...
export const WS_FEED_ADD_CURRENT_ITEM:"WS_FEED_ADD_CURRENT_ITEM" = "WS_FEED_ADD_CURRENT_ITEM";
export const GET_NUMBER_ORDER_REQUEST:"GET_NUMBER_ORDER_REQUEST" = "GET_NUMBER_ORDER_REQUEST";
export const GET_NUMBER_ORDER_SUCCESS:"GET_NUMBER_ORDER_SUCCESS" = "GET_NUMBER_ORDER_SUCCESS";
export const GET_NUMBER_ORDER_ERROR:"GET_NUMBER_ORDER_ERROR" = "GET_NUMBER_ORDER_ERROR";